...
[https://ireneburresi.github.io/normattiva-sdk/progetto/index.md](https://ireneburresi.github.io/normattiva-sdk/progetto/index.md).
...
- [`/llms.txt`](https://ireneburresi.github.io/normattiva-sdk/llms.txt), l'indice di tutte le pagine con una riga di
  descrizione ciascuna;
- [`/llms-full.txt`](https://ireneburresi.github.io/normattiva-sdk/llms-full.txt), l'intera documentazione in un file
  solo.
